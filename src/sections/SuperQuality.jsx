...
const SuperQuality = () => {
  return (
    <section id="about-us" className='flex justify-between items-center max-lg:flex-col gap-10 w-full ml-20'>
      <div className="flex flex-1 flex-col">
        ...
        <p className='mt-4 lg:max-w-lg info-text'>Ensuring Premium comfort and style, 
           our meticulously crafted footwears are designed to elevate your experience,
           providing you with unmatched quality, innovation, and a touch of elegance.
        </p>
        <p className='mt-6 lg:max-w-lg info-text'>Ensuring Premium comfort and style,
